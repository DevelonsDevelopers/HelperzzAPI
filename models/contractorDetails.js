...
module.exports = class ContractorDetails {
    ...
    static create (params){
        return database.query('INSERT INTO contractor_details (contractor, company_name, address, postal_code, category, subcategories, city, skills, availability_days, availability_hours, website, description, trust_seal) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [params.contractor, params.company_name, params.address, params.postal_code, params.category, params.subcategories, params.city, params.skills, params.availability_days, params.availability_hours, params.website, params.description, params.trust_seal])
    }
